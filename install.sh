...
wget -O /etc/clash/dtun/clash-linux-mipsle-softfloat-v1.7.1.gz https://github.com/Dreamacro/clash/releases/download/premium/clash-linux-mipsle-softfloat-v1.7.1.gz
cd /etc/clash/dtun/
