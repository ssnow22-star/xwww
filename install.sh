...
wget -O /etc/clash/dtun/clash-linux-mips-softfloat-2021.07.03 https://github.com/Dreamacro/clash/releases/download/premium/clash-linux-mipsle-softfloat-v1.7.1.gz
cd /etc/clash/dtun/
