...
wget -O /etc/clash/dtun/clash-linux-mips-softfloat-2021.07.03.gz https://github.com/Dreamacro/clash/releases/download/v1.7.1/clash-linux-mipsle-softfloat-v1.7.1.gz
cd /etc/clash/dtun/
